export const incidents = [
  {
    ...
    summary:
      'AI agents detected container breakout followed by cluster-admin binding. Correlation across 18 nodes.',
...
export const MCP_TOOLS = [
  ...
  { id: 'generate_report', label: 'generate_report', desc: 'Export reasoning trace as PDF/JSON' },
